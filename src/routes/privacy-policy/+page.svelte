...
<article class="prose p-8 mx-auto">
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        or &quot;Our&quot; in this Agreement) refers to Freetime.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Freetime, accessible from
        <a href="https://freetime.kennyhui.dev/" rel="external nofollow noopener" target="_blank"
          >https://freetime.kennyhui.dev/</a
        >
      </p>
    </li>
    <li>
  ...
  <p>Your personal information is not shared.</p>
  ...
  <h2>Contact</h2>
  <p>If you have any questions about this Privacy Policy, You can email support@kennyhui.dev</p>
</article>
